...
apiRouter.get('/repos/:name/commits/:commit', RepoAPI.repoMiddleware, commitAPI.commitMiddleware, commitAPI.detail)
apiRouter.get('/repos/:name/commits/:commit/tree/:path*', RepoAPI.repoMiddleware, commitAPI.commitMiddleware, commitAPI.listTree)
apiRouter.get('/repos/:name/commits/:commit/blob/:path(.*)', RepoAPI.repoMiddleware, commitAPI.commitMiddleware, commitAPI.blobFile)
